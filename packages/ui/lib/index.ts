...
export { default as ThemeComponent } from './themes/ThemeComponent';
export type { MuiThemeProps } from './themes/ThemeComponent';
...
export { default as useResponsiveness } from './hooks/useResponsiveness';
