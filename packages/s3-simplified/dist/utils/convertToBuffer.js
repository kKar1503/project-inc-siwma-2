        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, blobToBuffer(data)];
                case 1: return [2 /*return*/, _a.sent()];
                case 2:
                    if (!(data instanceof stream_1.Readable)) return [3 /*break*/, 4];
                    return [4 /*yield*/, readableToBuffer(data)];
                case 3: return [2 /*return*/, _a.sent()];
                case 4:
                    if (!(data instanceof ReadableStream)) return [3 /*break*/, 6];
                    return [4 /*yield*/, readableStreamToBuffer(data)];
                case 5: return [2 /*return*/, _a.sent()];
                case 6: throw new Error("Invalid data type");
            }
        });
    });
}
